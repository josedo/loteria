--------------------------------------------------------
-- Archivo creado  - viernes-julio-07-2017   
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "LOTERIA"."DRAFTS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into LOTERIA.DRAFTS (ID,DATE_DRAFT,NUMBER_1,NUMBER_2,NUMBER_3,NUMBER_4,NUMBER_5,NUMBER_6) values ('1',to_date('07/07/17','DD/MM/RR'),'0','0','0','0','0','0');
...
SET DEFINE OFF;
Insert into LOTERIA.USERS (ID,USERNAME,PASSWORD,FIRST_NAME,LAST_NAME,WALLET,PROFILES_ID,RUT,DV,EMAIL,STATUS) values ('1','admin','admin','Administrador','Supremo','497600','1','11111111','1','admin@loteria.net','1');
